package BatchProcessingLargeDataSets;
...
public class TracePerformanceAspect {
    ...
    @Around("execution(* BatchProcessingLargeDataSets..*.*(..)))")
    public Object logTracePerformanceAspect(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        long end = System.currentTimeMillis(); //Log method execution time
        logger.info("Execution time of " + className + "." + methodName + " :: " + (end - start) + " ms"); return result;
     }
}
